#### AutoLCA_2X - LIFE CYCLE ASSESSMENT (ISO 14040) SCRIPT FOR 2 PARALLEL ASSESSMENTS ####
...
#SETWD WINDOWS UAB - line to use if you are working in a UAB computer
...
LCI_2 <- read_excel("AutoLCA_EXCEL.xlsx", sheet = "LC2_SHEET2", col_types = c("text", "text", "text", "text", "text", "text", "numeric", "text", "numeric", "text", "numeric", "text", "numeric", "numeric", "numeric", "text", "text"))
...
RF2 = 2.222 #Add the Reference Flow for LCI_2 here
...
#LCI_2_NA <- dplyr::filter(LCI_2_NA, !Item %in% FilterList1)
...
LCI_2_NA$AssessmentLCI <- LCI_2_NA$Assessment_Length_years * LCI_2_NA$Total / LCI_2_NA$Lifespan_years
...
LCA_2 <- merge(LCI_2_NA, Imp1U, by = "Process")
...
LCA_2$Impacts <- LCA_2$AssessmentLCI * LCA_2$Imp1Unit
...
LCA_2$Impacts_FU <- LCA_2$Impacts / RF2
...
#LCA_2 - All Impact Categories
LCA_2_TOTAL <- LCA_2 %>% group_by(IC, System) %>% summarise(mean = mean(Impacts_FU), sum = sum(Impacts_FU))
...
#LCA_2 - All Impact Categories
LCA_2_SubSys <- LCA_2 %>% group_by(IC, Subsystem) %>% summarise(mean = mean(Impacts_FU), sum = sum(Impacts_FU))
LCA_2_Item <- LCA_2 %>% group_by(IC, Item) %>% summarise(mean = mean(Impacts_FU), sum = sum(Impacts_FU))


#Save the impact datasheets for all impact categories per Item - Library "writexl"
sheets <- list("LCA_1" = LCA_1_Item, "LCA_2" = LCA_2_Item)
...
LCA_2_1C <- dplyr::filter(LCA_2, IC == "Global warming") #Change Global Warming to select any other Impact Category
...
#LCA_2 - 1C
LCA_2I_1C <- ggplot(LCA_2_1C, aes(x = IC, y = Impacts_FU)) + 
geom_bar(aes(fill = Item), stat = "identity", position = "stack") +
ylab("Impact per FU") + xlab("Global Warming (kg CO2 eq)") + #Change the Lab title to adapt it to the selectec impact category
theme(axis.text.y = element_text(size = 15))
...
ggsave(path = "Fig1C", filename = "LCA_2I_1C.jpeg", plot = LCA_2I_1C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #LCA_2
...
#LCA_2 - 1C - Element
LCA_2E_1C <- ggplot(LCA_2_1C, aes(x = IC, y = Impacts_FU)) + 
  geom_bar(aes(fill = Element), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.y = element_text(size = 15))
...
ggsave(path = "Fig1C", filename = "LCA_2E_1C.jpeg", plot = LCA_2E_1C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #Lettuce - Batch 2
...
#LCA_2
LCA_2_2C <- dplyr::filter(LCA_2, IC %in% SelectedICs) #Filter
LCA_2_2C$IC = factor(LCA_2_2C$IC, levels=c("Global warming", "Fossil resource scarcity")) #Order to sort how they will appear in the plot
...
#LCA_2 - 2C - Item
LCA_2I_2C <- ggplot(LCA_2_2C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Item), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig2C", filename = "LCA_2I_2C.jpeg", plot = LCA_2I_2C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #LCA_2
...
#LCA_2 - 2C - Element
LCA_2E_2C <- ggplot(LCA_2_2C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Element), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig2C", filename = "LCA_2E_2C.jpeg", plot = LCA_2E_2C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #Lettuce - Batch 2
...
#LCA_2
LCA_2_3C <- dplyr::filter(LCA_2, IC %in% SelectedICs) #Filter
LCA_2_3C$IC = factor(LCA_2_3C$IC, levels=c("Global warming", "Fossil resource scarcity", "Land use")) #Order to sort how they will appear in the plot
...
#LCA_2 - 3C - Item
LCA_2I_3C <- ggplot(LCA_2_3C, aes(x = System, y = Impacts_FU)) + 
geom_bar(aes(fill = Item), stat = "identity", position = "stack") +
ylab("Impact per FU") + xlab("Impact Categories") +
theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
#facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig3C", filename = "LCA_2I_3C.jpeg", plot = LCA_2I_3C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #LCA_2
...
#LCA_2 - 3C - Element
LCA_2E_3C <- ggplot(LCA_2_3C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Element), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig3C", filename = "LCA_2E_3C.jpeg", plot = LCA_2E_3C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #Lettuce - Batch 2
...
#LCA_2
LCA_2_4C <- dplyr::filter(LCA_2, IC %in% SelectedICs) #Filter
LCA_2_4C$IC = factor(LCA_2_4C$IC, levels=c("Global warming", "Freshwater Eutrophication", "Marine Eutrophication", "Land use")) #Order to sort how they will appear in the plot
...
#LCA_2 - 4C - Item
LCA_2I_4C <- ggplot(LCA_2_4C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Item), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig4C", filename = "LCA_2I_4C.jpeg", plot = LCA_2I_4C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #LCA_2
...
#LCA_2 - 4C - Element
LCA_2E_4C <- ggplot(LCA_2_4C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Element), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig4C", filename = "LCA_2E_4C.jpeg", plot = LCA_2E_4C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #Lettuce - Batch 2
...
#LCA_2
LCA_2_5C <- dplyr::filter(LCA_2, IC %in% SelectedICs) #Filter
LCA_2_5C$IC = factor(LCA_2_5C$IC, levels=c("Global warming", "Freshwater Eutrophication", "Marine Eutrophication", "Fossil resource scarcity", "Land use")) #Order to sort how they will appear in the plot
...
#LCA_2 - 5C - Item
LCA_2I_5C <- ggplot(LCA_2_5C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Item), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig5C", filename = "LCA_2I_5C.jpeg", plot = LCA_2I_5C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #LCA_2
...
#LCA_2 - 5C - Element
LCA_2E_5C <- ggplot(LCA_2_5C, aes(x = System, y = Impacts_FU)) + 
  geom_bar(aes(fill = Element), stat = "identity", position = "stack") +
  ylab("Impact per FU") + xlab("Impact Categories") +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size = 15), strip.text.x = element_text(size = 15)) +
  #facet_wrap(~Abbr, scales = "free_y")
...
ggsave(path = "Fig5C", filename = "LCA_2E_5C.jpeg", plot = LCA_2E_5C, device = "jpeg", scale = 1, width = NA, height = NA, units = "mm", dpi = 300, bg = "white") #Lettuce - Batch 2